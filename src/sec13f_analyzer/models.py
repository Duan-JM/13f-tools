        ...
        if self.holdings:
            ...
            for holding in self.holdings:
                if self.total_value > 0:
                    holding.percentage_of_portfolio = (holding.market_value / self.total_value) * 100
                else:
...
class HoldingsChange:
    ...
    def __post_init__(self):
        ...
        if self.total_prev_value > 0:
            ...
            self.total_percentage_change = (self.total_value_change / self.total_prev_value) * 100
