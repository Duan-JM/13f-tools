...
class TestHoldings:
    ...
    def test_percentage_calculation(self):
        ...
        assert holdings.holdings[1].percentage_of_portfolio == pytest.approx(
            33.33, rel=1e-2
        )
        assert holdings.holdings[2].percentage_of_portfolio == pytest.approx(
            16.67, rel=1e-2
        )
...
class TestHoldingsChange:
    ...
    def create_sample_holdings_change(self):
        ...
        changes = [
            HoldingChange(
                "12345678", "Apple Inc.", "increased", 1000, 1500, 150000.0, 225000.0
            ),
            HoldingChange(
                "87654321", "Microsoft Corp.", "decreased", 500, 300, 100000.0, 60000.0
            ),
